 ...
 */
public class Node {
    public static final String NODE_NOME = "br.com.ceiot.node.nome";
    public static final String NODE_DESCRICAO = "br.com.ceiot.node.descricao";
    public static final String NODE_LOCALIZACAO = "br.com.ceiot.node.localizacao";
    private String nome;
