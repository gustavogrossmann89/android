...
public class Node {
    ...
    public static final String NODE_DTATUALIZACAO = "iotsensorcontrol.node.dtatualizacao";
    ...
    public Node(String nome, String descricao, String topicomqtt, String status, String dtatualizacao) {
        this.nome = nome;
